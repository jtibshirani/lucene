...
public abstract class PerFieldKnnVectorsFormat extends KnnVectorsFormat {
  ...
  private class FieldsWriter extends KnnVectorsWriter {
    ...
    @Override
    public void mergeVectors(FieldInfo mergeFieldInfo, MergeState mergeState) throws IOException {
      getInstance(mergeFieldInfo).mergeVectors(mergeFieldInfo, mergeState);
    }
