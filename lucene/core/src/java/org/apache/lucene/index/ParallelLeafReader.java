...
public class ParallelLeafReader extends LeafReader {
  ...
  @Override
  public TopDocs searchNearestVectors(String fieldName, float[] target, int k, Bits acceptDocs, float minScore)
      throws IOException {
    ensureOpen();
    LeafReader reader = fieldToReader.get(fieldName);
    return reader == null ? null : reader.searchNearestVectors(fieldName, target, k, acceptDocs, minScore);
  }
